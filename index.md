...
하나의 서비스가 프로젝트 생성부터 시작해서 서비스를 출시하기까지의 전반적인 개발 Process를 경험하며 개발 전과정에 대한 이해도를 높였습니다.

구독형 요금 모델을 통해 안정적인 수익 구조를 만들어내며 사용자가 만 명으로 성장하면서 실제 사용자 피드백을 반영하며 기능과 UX를 개선했습니다.
...
4. 더커머스 IT 스타트업 
- E-commerce 쇼핑몰 통합 관리 플랫폼 개발 (www.onesell.co.kr, m.onesell.co.kr)
- [본인의 역할 및 성과] 
- 백엔드 개발 및 모바일 웹 개발, 배포, 운영 관리 (SpringBoot, AWS, Vue, MongoDB)
...
하나의 서비스를 출시하기 위해 소수의 개발자 인원들과 함께 Git을 통한 프로젝트 작업들을 공동으로 협업하였고 프로젝트 생성부터 시작해서 하나의 서비스를 출시하기까지의 프로세스를 함께하였습니다.
